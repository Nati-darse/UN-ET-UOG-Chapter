            ...
            <div className="relative">
              ...
              {isDropdownOpen && (
                <ul className="absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 mt-2 w-48 bg-[#002D62] border border-gray-300 rounded shadow-lg z-10 text-white">
                  <li>
                    <a href="https://www.linkedin.com/in/nathnael-darsema/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 hover:bg-blue-900">
                      Nathanael Darsema
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 hover:bg-blue-900">
                      Mariamawit Tesfaye 
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/in/mikias24/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 hover:bg-blue-900">
                    Mikias Wondafrash
                    </a>
                  </li>
                </ul>
